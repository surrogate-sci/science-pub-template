...
You can also open an issue, or use the publication's comment box when its maintainers have optionally enabled Giscus.
...
::: {.callout-note}
Discuss contributor credit and authorship with the publication maintainers before release.
:::
...
Once we approve and merge your pull request, we'll publish a new version of the pub. We'll notify you when this new version goes live at the [hosted URL](https://surrogate-sci.dev/{{< var pub.repo >}}/). Thanks for contributing!
