...
To obtain a local copy of this repo, you can either *clone* it directly or fork it to your own GitHub account, then clone your fork. If you aren't sure which to choose, clone directly for reproduction and fork when you intend to propose revisions.
